...
<body>
	...
	<div class="container-contact100">
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action=hasil.php method=post>
				<span class="contact100-form-title">
					Menghitung Body Mass Index Tubuh
				</span>

				<div class="wrap-input100 validate-input" data-validate = "Belum diisi">
					<input id="berat" class="input100" type="text" name="berat" placeholder="Berat Anda (Kg)">
